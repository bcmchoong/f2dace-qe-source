...
!# 57 "rotate_wfc_gamma.f90"
  npw2  = 2 * npw
  npwx2 = 2 * npwx
!# 60 "rotate_wfc_gamma.f90"
  IF ( gstart == -1 ) CALL errore( 'regter', 'gstart variable not initialized', 1 )
!# 62 "rotate_wfc_gamma.f90"
  !
...
!# 426 "rotate_wfc_gamma.f90"
              ...
              END IF
              ! 
!# 445 "rotate_wfc_gamma.f90"
              beta = 1.0d0
!# 447 "rotate_wfc_gamma.f90"
           END DO
           !
        END IF
        !
