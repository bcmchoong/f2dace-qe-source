...
!# 450 "rotate_xpsi_gamma.f90"
           ! use blas subs. on the matrix block
!# 452 "rotate_xpsi_gamma.f90"
           CALL DGEMM( 'T', 'N', nr, nc, npw2, 2.D0, v(1,ir), npwx2, w(1,ic), npwx2, 0.D0, work, nx )
!# 454 "rotate_xpsi_gamma.f90"
           IF ( gstart == 2 ) &
              CALL DGER( nr, nc, -1.D0, v(1,ir), npwx2, w(1,ic), npwx2, work, nx )
!# 457 "rotate_xpsi_gamma.f90"
           ! accumulate result on dm of root proc.
!# 459 "rotate_xpsi_gamma.f90"
           CALL mp_root_sum( work, dm, root, ortho_parent_comm )
!# 461 "rotate_xpsi_gamma.f90"
        END DO
        !
     END DO
!# 465 "rotate_xpsi_gamma.f90"
...
!# 502 "rotate_xpsi_gamma.f90"
              ...
              END IF
              ! 
!# 537 "rotate_xpsi_gamma.f90"
              beta = 1.0d0
!# 539 "rotate_xpsi_gamma.f90"
           END DO
           !
        END IF
        !
