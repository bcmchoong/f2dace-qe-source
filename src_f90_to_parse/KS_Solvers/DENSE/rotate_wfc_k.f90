...
!# 412 "rotate_wfc_k.f90"
              ...
              END IF
              ! 
!# 431 "rotate_wfc_k.f90"
              beta = ( 1.D0, 0.D0 )
!# 433 "rotate_wfc_k.f90"
           END DO
           !
        END IF
        !
     ...
     !$acc end data
     DEALLOCATE( vtmp )
!# 442 "rotate_wfc_k.f90"
     RETURN
  END SUBROUTINE refresh_evc
!# 445 "rotate_wfc_k.f90"
