...
!# 490 "rotate_xpsi_k.f90"
              ...
              END IF
              ! 
!# 525 "rotate_xpsi_k.f90"
              beta = ( 1.D0, 0.D0 )
!# 527 "rotate_xpsi_k.f90"
           END DO
           !
        END IF
        !
