...
!# 37 "ccgdiagg.f90"
  ...
  DO m = 1, nbnd
     ...
     IF(m_start.le.m_end) THEN
       CALL MYZGEMV( 'C', kdim, m_end-m_start+1, ( 1.D0, 0.D0 ), psi(1,m_start), &
                   kdmx, spsi, 1, ( 0.D0, 0.D0 ), lagrange(m_start), 1 )
     END IF
