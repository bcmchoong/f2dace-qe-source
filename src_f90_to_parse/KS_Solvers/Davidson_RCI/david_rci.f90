...
!# 214 "david_rci.f90"
    case(2)
      ...
      vc(:,:) = ( 0.D0, 0.D0 )
      !
      CALL ZGEMM( 'C', 'N', nbase, nbase, kdim, ( 1.D0, 0.D0 ), &
        work%psi, kdmx, work%hpsi, kdmx, ( 0.D0, 0.D0 ), hc, nvecx )
      !
      ...
      IF ( uspp ) THEN
        !
        CALL ZGEMM( 'C', 'N', nbase, nbase, kdim, ( 1.D0, 0.D0 ), &
          work%psi, kdmx, work%spsi, kdmx, ( 0.D0, 0.D0 ), sc, nvecx )
        !     
      ELSE
        !
        CALL ZGEMM( 'C', 'N', nbase, nbase, kdim, ( 1.D0, 0.D0 ), &
          work%psi, kdmx, work%psi, kdmx, ( 0.D0, 0.D0 ), sc, nvecx )
        !
      END IF
      !
...
!# 269 "david_rci.f90"
    ...
    case (3)
      ...
      IF ( uspp ) THEN
        !
        CALL ZGEMM( 'N', 'N', kdim, notcnv, nbase, ( 1.D0, 0.D0 ), work%spsi, &
          kdmx, vc, nvecx, ( 0.D0, 0.D0 ), work%psi(1,1,nb1), kdmx )
        !     
      ELSE
        !
        CALL ZGEMM( 'N', 'N', kdim, notcnv, nbase, ( 1.D0, 0.D0 ), work%psi, &
          kdmx, vc, nvecx, ( 0.D0, 0.D0 ), work%psi(1,1,nb1), kdmx )
        !
      END IF
      !
      ...
      END DO
      !
      CALL ZGEMM( 'N', 'N', kdim, notcnv, nbase, ( 1.D0, 0.D0 ), work%hpsi, &
        kdmx, vc, nvecx, ( 1.D0, 0.D0 ), work%psi(1,1,nb1), kdmx )
      !
...
!# 381 "david_rci.f90"
    case (5)
      ...
      !
      CALL ZGEMM( 'C', 'N', nbase+notcnv, notcnv, kdim, ( 1.D0, 0.D0 ), work%psi, &
        kdmx, work%hpsi(1,1,nb1), kdmx, ( 0.D0, 0.D0 ), hc(1,nb1), nvecx )
      !
      ...
      IF ( uspp ) THEN
        !
        CALL ZGEMM( 'C', 'N', nbase+notcnv, notcnv, kdim, ( 1.D0, 0.D0 ), work%psi, &
          kdmx, work%spsi(1,1,nb1), kdmx, ( 0.D0, 0.D0 ), sc(1,nb1), nvecx )
        !     
      ELSE
        !
        CALL ZGEMM( 'C', 'N', nbase+notcnv, notcnv, kdim, ( 1.D0, 0.D0 ), work%psi, &
          kdmx, work%psi(1,1,nb1), kdmx, ( 0.D0, 0.D0 ), sc(1,nb1), nvecx )
        !
      END IF
      !
      ...
      IF ( notcnv == 0 .or. dav_iter == maxter ) THEN
        ...
        !
        CALL ZGEMM( 'N', 'N', kdim, nvec, nbase, ( 1.D0, 0.D0 ), &
          work%psi, kdmx, vc, nvecx, ( 0.D0, 0.D0 ), evc, kdmx )
        !
      ...
      IF ( nbase+notcnv > nvecx) THEN
        ...
        IF ( uspp ) THEN
          !
          CALL ZGEMM( 'N', 'N', kdim, nvec, nbase, ( 1.D0, 0.D0 ), work%spsi, &
            kdmx, vc, nvecx, ( 0.D0, 0.D0 ), work%psi(1,1,nvec+1), kdmx )
          !
          work%spsi(:,:,1:nvec) = work%psi(:,:,nvec+1:nvec+nvec)
          !
        END IF
        !
        CALL ZGEMM( 'N', 'N', kdim, nvec, nbase, ( 1.D0, 0.D0 ), work%hpsi, &
          kdmx, vc, nvecx, ( 0.D0, 0.D0 ), work%psi(1,1,nvec+1), kdmx )
        !
