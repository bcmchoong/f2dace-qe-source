...
!
!-------------------------------------------------------------------------------
SUBROUTINE paro_k( h_psi_ptr, s_psi_ptr, hs_1psi_ptr, g_psi_ptr, overlap, &
...
!# 131 "paro_k.f90"
     ...
     DO ibnd=ibnd_start,ibnd_end
        ...
        CALL pcg_k(hs_1psi, g_psi, psi2, evc, npw, npwx, nbnd, npol, psi2(:,nbase+ibnd), ethr, iter, eig(ibnd), nhpsi)
     END DO
