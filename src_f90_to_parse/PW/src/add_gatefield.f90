...
!# 60 "add_gatefield.f90"
  LOGICAL :: offrange, first=.TRUE.
!# 62 "add_gatefield.f90"
  SAVE first
  
  !---------------------
  !  Execution control
  !---------------------
!# 68 "add_gatefield.f90"
  IF (.NOT.gate) RETURN
  !write (*,*) ' enter gate '; FLUSH(6)
!# 71 "add_gatefield.f90"
...
!# 86 "add_gatefield.f90"
  !---------------------
  !  Variable initialization
  !---------------------
!# 90 "add_gatefield.f90"
...
!# 146 "add_gatefield.f90"
        ...
        ENDDO
!# 152 "add_gatefield.f90"
     ENDDO
     !
     !   deallocate work space
     !
     DEALLOCATE(xau)
!# 158 "add_gatefield.f90"
  ENDIF
!# 161 "add_gatefield.f90"
  IF (ionode) THEN
       !
       ! Output data
       !
...
!# 182 "add_gatefield.f90"
       ...
       ENDIF
!# 195 "add_gatefield.f90"
       WRITE( stdout,*)
  ENDIF
!# 199 "add_gatefield.f90"
  !
...
!# 272 "add_gatefield.f90"
     IF (quadratic) THEN   ! quadratic part of the potential, i.e. the background charge
        ...
        vpoten(ir) = vpoten(ir) + value
     ENDIF
!# 277 "add_gatefield.f90"
  END DO
!# 279 "add_gatefield.f90"
  first=.FALSE.
!# 281 "add_gatefield.f90"
  RETURN
!# 283 "add_gatefield.f90"
