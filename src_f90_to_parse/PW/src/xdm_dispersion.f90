...
!# 276 "xdm_dispersion.f90"
    ...
    END DO
    DEALLOCATE(d1y,d2y)
!# 285 "xdm_dispersion.f90"
    CALL stop_clock('init_xdm')
!# 287 "xdm_dispersion.f90"
  END SUBROUTINE init_xdm
!# 289 "xdm_dispersion.f90"
  !--------------------------------------------------------------
...
!# 311 "xdm_dispersion.f90"
  ...
  FUNCTION energy_xdm() RESULT( evdw )
    ...
    INTEGER :: ispin
    REAL(DP) :: iix, iiy, iiz
!# 365 "xdm_dispersion.f90"
    INTEGER, EXTERNAL :: atomic_number
!# 367 "xdm_dispersion.f90"
    CALL start_clock('energy_xdm')
!# 369 "xdm_dispersion.f90"
    ! initialize
...
!# 411 "xdm_dispersion.f90"
       ...
       ENDIF
!# 419 "xdm_dispersion.f90"
       ! don't need the core anymore
       DEALLOCATE(rhocor)
!# 422 "xdm_dispersion.f90"
...
!# 489 "xdm_dispersion.f90"
          ...
          END DO
!# 502 "xdm_dispersion.f90"
          ! integrate atomic volumes and moments
          DO iat = 1, nat
             it = ityp(iat)
             nn = msh(it)
             taub = tau(:,iat) * alat
!# 508 "xdm_dispersion.f90"
...
!# 608 "xdm_dispersion.f90"
    ...
    for = 0._DP
    sigma = 0._DP
!# 617 "xdm_dispersion.f90"
    ehadd = 0._DP
!# 619 "xdm_dispersion.f90"
    ...
    rmax2 = rmax*rmax
    CALL set_environ(rmax,lmax(1),lmax(2),lmax(3))
!# 626 "xdm_dispersion.f90"
    ! parallelize over atoms
!# 638 "xdm_dispersion.f90"
    first = 1
    last  = nat
!# 642 "xdm_dispersion.f90"
    DO i = first, last
       sat = 0._DP
       eat = 0._DP
       taub = tau(:,i) * alat
!# 647 "xdm_dispersion.f90"
       ! C6, C8, C10
       DO i3 = 2, 4
          ! order R^nn
          nn = 2 * (i3 + 1)
!# 652 "xdm_dispersion.f90"
          DO j = 1, nenv
             jj = ienv(j)
             xij = xenv(:,j) - taub
...
!# 691 "xdm_dispersion.f90"
    ...
    ENDDO
!# 698 "xdm_dispersion.f90"
    IF (nspin == 2) CALL rhoz_or_updw( rho, 'r_and_g', '->rhoz' )
!# 700 "xdm_dispersion.f90"
    ! convert to Ry
    evdw = evdw * 2
    for = for * 2
    sigma = sigma * 2
    ehadd = ehadd * 2
!# 706 "xdm_dispersion.f90"
    ! save energy, forces and stress tensor
    esaveold = esave
    esave = evdw
    fsave = for(:,1:nat)
    ssave = sigma
!# 712 "xdm_dispersion.f90"
    IF (ionode) THEN
       ! write to output
       ...
       WRITE (stdout,*)
    END IF
!# 730 "xdm_dispersion.f90"
    CALL stop_clock('energy_xdm')
!# 732 "xdm_dispersion.f90"
  ...
  SUBROUTINE write_xdmdat()
    ...
    INTEGER :: iunxdm, ierr
    LOGICAL :: lexist
!# 770 "xdm_dispersion.f90"
    INTEGER, EXTERNAL :: find_free_unit
!# 772 "xdm_dispersion.f90"
...
!# 860 "xdm_dispersion.f90"
       ...
       END DO ! jj
    END DO ! ii
!# 867 "xdm_dispersion.f90"
    CALL stop_clock('exdm:environ')
!# 869 "xdm_dispersion.f90"
...
!# 981 "xdm_dispersion.f90"
       ...
       ENDDO
       DEALLOCATE(d1y,d2y)
!# 995 "xdm_dispersion.f90"
       ALLOCATE(ylm_posi(1,i%l**2))
!# 997 "xdm_dispersion.f90"
...
!# 1029 "xdm_dispersion.f90"
    ...
    ENDDO atoms
    DEALLOCATE(rho_lm)
!# 1038 "xdm_dispersion.f90"
    CALL stop_clock('exdm:paw_charge')
!# 1040 "xdm_dispersion.f90"
  END SUBROUTINE PAW_make_ae_charge_xdm
!# 1042 "xdm_dispersion.f90"
...
!# 1100 "xdm_dispersion.f90"
    ...
    END DO
!# 1109 "xdm_dispersion.f90"
    CALL stop_clock('exdm:rho')
!# 1111 "xdm_dispersion.f90"
  END SUBROUTINE promolecular_rho
!# 1113 "xdm_dispersion.f90"
  ...
  SUBROUTINE setxdm_a1a2( a1i, a2i )
    ...
    END IF
!# 1227 "xdm_dispersion.f90"
  END SUBROUTINE setxdm_a1a2
!# 1229 "xdm_dispersion.f90"
  !-----------------------------------------------------------------------------------
