...
!# 1205 "divide_class.f90"
 char_mat=(1.d0,0.d0)
!# 1207 "divide_class.f90"
name_class(1)="E   "
!# 1209 "divide_class.f90"
ir_ram="   "
!# 1211 "divide_class.f90"
IF (code_group==1) THEN
   !
   ! C_1
   !
...
ELSEIF (code_group==11) THEN
   ...
   name_class(5)="3C2' "
   name_class(6)="3C2''"
!# 1458 "divide_class.f90"
   name_rap(1)="A_1 "
   ir_ram(1)="R"
!# 1461 "divide_class.f90"
   name_rap(2)="A_2 "
   ir_ram(2)="I"
   char_mat(2,5)=(-1.d0,0.d0)
   char_mat(2,6)=(-1.d0,0.d0)
!# 1466 "divide_class.f90"
   name_rap(3)="B_1 "
   char_mat(3,2)=(-1.d0,0.d0)
   char_mat(3,4)=(-1.d0,0.d0)
   char_mat(3,6)=(-1.d0,0.d0)
!# 1471 "divide_class.f90"
   name_rap(4)="B_2 "
   char_mat(4,2)=(-1.d0,0.d0)
   char_mat(4,4)=(-1.d0,0.d0)
   char_mat(4,5)=(-1.d0,0.d0)
!# 1476 "divide_class.f90"
   name_rap(5)="E_1 "
   ir_ram(5)="I+R"
   char_mat(5,1)=( 2.d0,0.d0)
...
!# 1502 "divide_class.f90"
   ...
   char_mat(2,3)=(-1.d0,0.d0)
   char_mat(2,4)=(-1.d0,0.d0)
!# 1510 "divide_class.f90"
   name_rap(3)="B_1  D_3  S_3"
   ir_ram(3)="I+R"
   char_mat(3,2)=(-1.d0,0.d0)
   char_mat(3,4)=(-1.d0,0.d0)
!# 1515 "divide_class.f90"
   name_rap(4)="B_2  D_4  S_4"
   ir_ram(4)="I+R"
   char_mat(4,2)=(-1.d0,0.d0)
   char_mat(4,3)=(-1.d0,0.d0)
!# 1520 "divide_class.f90"
ELSEIF (code_group==13) THEN
   !
   ! C_3v
   !
   ...
   name_class(2)="2C3  "
   name_class(3)="3s_v "
!# 1528 "divide_class.f90"
   name_rap(1)="A_1  L_1"
   ir_ram(1)="I+R"
!# 1531 "divide_class.f90"
   name_rap(2)="A_2  L_2"
   char_mat(2,3)=(-1.d0,0.d0)
!# 1534 "divide_class.f90"
   name_rap(3)="E    L_3"
   ir_ram(3)="I+R"
   char_mat(3,1)=( 2.d0,0.d0)
   char_mat(3,2)=(-1.d0,0.d0)
   char_mat(3,3)=( 0.d0,0.d0)
!# 1540 "divide_class.f90"
ELSEIF (code_group==14) THEN
   !
   ! C_4v
   !
   ...
   name_class(4)="2s_v "
   name_class(5)="2s_d "
!# 1550 "divide_class.f90"
   name_rap(1)="A_1  G_1 D_1"
   ir_ram(1)="I+R"
!# 1553 "divide_class.f90"
   name_rap(2)="A_2  G_2 D_1'"
   char_mat(2,4)=(-1.d0,0.d0)
   char_mat(2,5)=(-1.d0,0.d0)
!# 1557 "divide_class.f90"
   name_rap(3)="B_1  G_3 D_2"
   ir_ram(3)="R"
   char_mat(3,2)=(-1.d0,0.d0)
   char_mat(3,5)=(-1.d0,0.d0)
!# 1562 "divide_class.f90"
   name_rap(4)="B_2  G_4 D_2'"
   ir_ram(4)="R"
   char_mat(4,2)=(-1.d0,0.d0)
   char_mat(4,4)=(-1.d0,0.d0)
!# 1567 "divide_class.f90"
...
ELSEIF (code_group==15) THEN
   ...
   name_class(5)="3s_v "
   name_class(6)="3s_d "
!# 1586 "divide_class.f90"
   name_rap(1)="A_1 "
   ir_ram(1)="I+R"
!# 1589 "divide_class.f90"
   name_rap(2)="A_2 "
   char_mat(2,5)=(-1.d0,0.d0)
   char_mat(2,6)=(-1.d0,0.d0)
!# 1593 "divide_class.f90"
   name_rap(3)="B_1 "
   char_mat(3,2)=(-1.d0,0.d0)
   char_mat(3,4)=(-1.d0,0.d0)
   char_mat(3,6)=(-1.d0,0.d0)
!# 1598 "divide_class.f90"
   name_rap(4)="B_2 "
   char_mat(4,2)=(-1.d0,0.d0)
   char_mat(4,4)=(-1.d0,0.d0)
   char_mat(4,5)=(-1.d0,0.d0)
!# 1603 "divide_class.f90"
   name_rap(5)="E_1 "
   ir_ram(5)="I+R"
   char_mat(5,1)=( 2.d0,0.d0)
   char_mat(5,3)=(-1.d0,0.d0)
...
ELSEIF (code_group==16) THEN
   ...
   name_class(3)="i    "
   name_class(4)="s_h  "
!# 1629 "divide_class.f90"
   name_rap(1)="A_g "
   ir_ram(1)="R"
!# 1632 "divide_class.f90"
   name_rap(2)="B_g "
   ir_ram(2)="R"
   char_mat(2,2)=(-1.d0,0.d0)
   char_mat(2,4)=(-1.d0,0.d0)
!# 1637 "divide_class.f90"
   name_rap(3)="A_u "
   ir_ram(3)="I"
   char_mat(3,3)=(-1.d0,0.d0)
   char_mat(3,4)=(-1.d0,0.d0)
!# 1642 "divide_class.f90"
   name_rap(4)="B_u "
   ir_ram(4)="I"
   char_mat(4,2)=(-1.d0,0.d0)
   char_mat(4,3)=(-1.d0,0.d0)
!# 1647 "divide_class.f90"
ELSEIF (code_group==17) THEN
   !
   ! C_3h
   !
...
!# 1668 "divide_class.f90"
   ...
   char_mat(3,5)=CMPLX(-0.5d0,-sqr3d2,kind=DP)
   char_mat(3,6)=CMPLX(-0.5d0,sqr3d2,kind=DP)
!# 1675 "divide_class.f90"
   name_rap(4)="A'' "
   ir_ram(4)="I"
   char_mat(4,4)=(-1.d0,0.d0)
   char_mat(4,5)=(-1.d0,0.d0)
   char_mat(4,6)=(-1.d0,0.d0)
!# 1681 "divide_class.f90"
   name_rap(5)="E'' "
   ir_ram(5)="R"
   char_mat(5,2)=CMPLX(-0.5d0,sqr3d2,kind=DP)
   char_mat(5,3)=CMPLX(-0.5d0,-sqr3d2,kind=DP)
...
ELSEIF (code_group==18) THEN
   ...
   name_class(7)="s_h  "
   name_class(8)="S4   "
!# 1711 "divide_class.f90"
   name_rap(1)="A_g "
   ir_ram(1)="R"
!# 1714 "divide_class.f90"
   name_rap(2)="B_g "
   ir_ram(2)="R"
   char_mat(2,2)=(-1.d0,0.d0)
   char_mat(2,4)=(-1.d0,0.d0)
...
ELSEIF (code_group==19) THEN
   ...
   name_class(11)="S6  "
   name_class(12)="S3  "
!# 1787 "divide_class.f90"
   name_rap(1)="A_g "
   ir_ram(1)="R"
!# 1790 "divide_class.f90"
   name_rap(2)="B_g "
   char_mat(2,2)=(-1.d0,0.d0)
   char_mat(2,4)=(-1.d0,0.d0)
   char_mat(2,6)=(-1.d0,0.d0)
...
!# 1943 "divide_class.f90"
   ...
   char_mat(4,6)=(-1.d0,0.d0)
   char_mat(4,7)=(-1.d0,0.d0)
!# 1950 "divide_class.f90"
   name_rap(5)="A_u "
   char_mat(5,5)=(-1.d0,0.d0)
   char_mat(5,6)=(-1.d0,0.d0)
   char_mat(5,7)=(-1.d0,0.d0)
   char_mat(5,8)=(-1.d0,0.d0)
!# 1956 "divide_class.f90"
   name_rap(6)="B_1u"
   ir_ram(6)="I"
   char_mat(6,3)=(-1.d0,0.d0)
   char_mat(6,4)=(-1.d0,0.d0)
...
ELSEIF (code_group==21) THEN
   ...
   name_class(5)="2S3  "
   name_class(6)="3s_v "
!# 1988 "divide_class.f90"
   name_rap(1)="A'_1"
   ir_ram(1)="R"
!# 1991 "divide_class.f90"
   name_rap(2)="A'_2"
   char_mat(2,3)=(-1.d0,0.d0)
   char_mat(2,6)=(-1.d0,0.d0)
!# 1995 "divide_class.f90"
   name_rap(3)="E'  "
   ir_ram(3)="I+R"
   char_mat(3,1)=( 2.d0,0.d0)
   char_mat(3,2)=(-1.d0,0.d0)
...
!# 2004 "divide_class.f90"
   name_rap(4)="A''1"
   char_mat(4,4)=(-1.d0,0.d0)
   char_mat(4,5)=(-1.d0,0.d0)
   char_mat(4,6)=(-1.d0,0.d0)
!# 2009 "divide_class.f90"
   name_rap(5)="A''2"
   ir_ram(5)="I"
   char_mat(5,3)=(-1.d0,0.d0)
   char_mat(5,4)=(-1.d0,0.d0)
   char_mat(5,5)=(-1.d0,0.d0)
!# 2015 "divide_class.f90"
   name_rap(6)="E'' "
   ir_ram(6)="R"
   char_mat(6,1)=( 2.d0,0.d0)
   char_mat(6,2)=(-1.d0,0.d0)
...
ELSEIF (code_group==24) THEN
   ...
   name_class(4)="2C2' "
   name_class(5)="2s_d "
!# 2255 "divide_class.f90"
   name_rap(1)="A_1  X_1  W_1"
   ir_ram(1)="R"
!# 2258 "divide_class.f90"
   name_rap(2)="A_2  X_4  W_2'"
   char_mat(2,4)=(-1.d0,0.d0)
   char_mat(2,5)=(-1.d0,0.d0)
!# 2262 "divide_class.f90"
   name_rap(3)="B_1  X_2  W_1'"
   ir_ram(3)="R"
   char_mat(3,2)=(-1.d0,0.d0)
   char_mat(3,5)=(-1.d0,0.d0)
!# 2267 "divide_class.f90"
   name_rap(4)="B_2  X_3  W_2"
   ir_ram(4)="I+R"
   char_mat(4,2)=(-1.d0,0.d0)
   char_mat(4,4)=(-1.d0,0.d0)
!# 2272 "divide_class.f90"
...
ELSEIF (code_group==25) THEN
   ...
   name_class(5)="2S6  "
   name_class(6)="3s_d "
!# 2291 "divide_class.f90"
   name_rap(1)="A_1g L_1"
   ir_ram(1)="R"
!# 2294 "divide_class.f90"
   name_rap(2)="A_2g L_2"
   char_mat(2,3)=(-1.d0,0.d0)
   char_mat(2,6)=(-1.d0,0.d0)
!# 2298 "divide_class.f90"
   name_rap(3)="E_g  L_3"
   ir_ram(3)="R"
   char_mat(3,1)=( 2.d0,0.d0)
   char_mat(3,2)=(-1.d0,0.d0)
   ...
   char_mat(3,5)=(-1.d0,0.d0)
   char_mat(3,6)=( 0.d0,0.d0)
!# 2307 "divide_class.f90"
   name_rap(4)="A_1u L_1'"
   char_mat(4,4)=(-1.d0,0.d0)
   char_mat(4,5)=(-1.d0,0.d0)
   char_mat(4,6)=(-1.d0,0.d0)
!# 2312 "divide_class.f90"
   name_rap(5)="A_2u L_2'"
   ir_ram(5)="I"
   char_mat(5,3)=(-1.d0,0.d0)
   char_mat(5,4)=(-1.d0,0.d0)
   char_mat(5,5)=(-1.d0,0.d0)
!# 2318 "divide_class.f90"
   name_rap(6)="E_u  L_3'"
   ir_ram(6)="I"
   char_mat(6,1)=( 2.d0,0.d0)
   char_mat(6,2)=(-1.d0,0.d0)
...
ELSEIF (code_group==26) THEN
   ...
   name_class(3)="C2   "
   name_class(4)="S4   "
!# 2335 "divide_class.f90"
   name_rap(1)="A    W_1"
   ir_ram(1)="R"
!# 2338 "divide_class.f90"
   name_rap(2)="B    W_3"
   ir_ram(2)="I+R"
   char_mat(2,2)=(-1.d0,0.d0)
   char_mat(2,4)=(-1.d0,0.d0)
!# 2343 "divide_class.f90"
   name_rap(3)="E    W_4"
   ir_ram(3)="I+R"
   char_mat(3,2)=( 0.d0, 1.d0)
   char_mat(3,3)=(-1.d0,0.d0)
   char_mat(3,4)=( 0.d0,-1.d0)
!# 2349 "divide_class.f90"
   name_rap(4)="E*   W_2"
   ir_ram(4)="I+R"
   char_mat(4,2)=( 0.d0,-1.d0)
   char_mat(4,3)=(-1.d0,0.d0)
   char_mat(4,4)=( 0.d0, 1.d0)
!# 2355 "divide_class.f90"
ELSEIF (code_group==27) THEN
   ...
   name_class(5)="S6^5 "
   name_class(6)="S6   "
!# 2367 "divide_class.f90"
   name_rap(1)="A_g "
   ir_ram(1)="R"
!# 2370 "divide_class.f90"
   name_rap(2)="E_g "
   ir_ram(2)="R"
   char_mat(2,2)=CMPLX(-0.5d0,sqr3d2,kind=DP)
   char_mat(2,3)=CMPLX(-0.5d0,-sqr3d2,kind=DP)
...
!# 2377 "divide_class.f90"
   ...
   char_mat(3,5)=CMPLX(-0.5d0,-sqr3d2,kind=DP)
   char_mat(3,6)=CMPLX(-0.5d0,sqr3d2,kind=DP)
!# 2384 "divide_class.f90"
   name_rap(4)="A_u "
   ir_ram(4)="I"
   char_mat(4,4)=(-1.d0,0.d0)
   char_mat(4,5)=(-1.d0,0.d0)
   char_mat(4,6)=(-1.d0,0.d0)
!# 2390 "divide_class.f90"
   name_rap(5)="E_u "
   ir_ram(5)="I"
   char_mat(5,2)=CMPLX(-0.5d0,sqr3d2,kind=DP)
   char_mat(5,3)=CMPLX(-0.5d0,-sqr3d2,kind=DP)
...
ELSEIF (code_group==28) THEN
   ...
   name_class(3)="4C3  "
   name_class(4)="4C3' "
!# 2416 "divide_class.f90"
   name_rap(1)="A   "
   ir_ram(1)="R"
!# 2419 "divide_class.f90"
   name_rap(2)="E   "
   ir_ram(2)="R"
   char_mat(2,3)=CMPLX(-0.5d0, sqr3d2,kind=DP)
   char_mat(2,4)=CMPLX(-0.5d0,-sqr3d2,kind=DP)
!# 2424 "divide_class.f90"
   name_rap(3)="E*  "
   ir_ram(3)="R"
   char_mat(3,3)=CMPLX(-0.5d0,-sqr3d2,kind=DP)
   char_mat(3,4)=CMPLX(-0.5d0, sqr3d2,kind=DP)
!# 2429 "divide_class.f90"
   name_rap(4)="T   "
   ir_ram(4)="I+R"
...
ELSEIF (code_group==29) THEN
   ...
   name_class(7)="4S6^5"
   name_class(8)="4S6  "
!# 2449 "divide_class.f90"
   name_rap(1)="A_g "
   ir_ram(1)="R"
!# 2452 "divide_class.f90"
   name_rap(2)="E_g "
   ir_ram(2)="R"
   char_mat(2,3)=CMPLX(-0.5d0, sqr3d2,kind=DP)
   char_mat(2,4)=CMPLX(-0.5d0,-sqr3d2,kind=DP)
...
ELSEIF (code_group==30) THEN
   ...
   name_class(4)="6S4  "
   name_class(5)="6s_d "
!# 2520 "divide_class.f90"
   name_rap(1)="A_1  G_1  P_1"
   ir_ram(1)="R"
!# 2523 "divide_class.f90"
   name_rap(2)="A_2  G_2  P_2"
   char_mat(2,4)=(-1.d0,0.d0)
   char_mat(2,5)=(-1.d0,0.d0)
!# 2527 "divide_class.f90"
...
ELSEIF (code_group==31) THEN
   ...
   name_class(4)="6C4  "
   name_class(5)="6C2' "
!# 2558 "divide_class.f90"
   name_rap(1)="A_1 "
   ir_ram(1)="R"
!# 2561 "divide_class.f90"
   name_rap(2)="A_2 "
   char_mat(2,4)=(-1.d0,0.d0)
   char_mat(2,5)=(-1.d0,0.d0)
!# 2565 "divide_class.f90"
   name_rap(3)="E   "
   ir_ram(3)="R"
   char_mat(3,1)=( 2.d0,0.d0)
   char_mat(3,2)=(-1.d0,0.d0)
...
ELSEIF (code_group==32) THEN
   ...
   name_class(9)="6S4  "
   name_class(10)="6s_d "
!# 2602 "divide_class.f90"
   name_rap(1)="A_1g G_1   G_1+"
   ir_ram(1)="R"
!# 2605 "divide_class.f90"
   name_rap(2)="A_2g G_2   G_2+"
   char_mat(2,4)=(-1.d0,0.d0)
   char_mat(2,5)=(-1.d0,0.d0)
   char_mat(2,9)=(-1.d0,0.d0)
   char_mat(2,10)=(-1.d0,0.d0)
!# 2611 "divide_class.f90"
