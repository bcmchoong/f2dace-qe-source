...
!# 413 "dynamics_module.f90"
      ...
      tau(:,:) = tau_new(:,:)
      !
!# 431 "dynamics_module.f90"
      !
      CALL output_tau( .FALSE., .FALSE. )
      !
!# 435 "dynamics_module.f90"
      !
...
!# 670 "dynamics_module.f90"
      ...
      tau(:,:) = tau_new(:,:)
      vel(:,:) = vel_tmp(:,:)
!# 727 "dynamics_module.f90"
      !
!# 729 "dynamics_module.f90"
      !
      CALL output_tau( .FALSE., .FALSE. )
      !
!# 733 "dynamics_module.f90"
      !
      ! ... infos are written on the standard output
      !
      WRITE( stdout, '(5X,"kinetic energy (Ekin) = ",F20.8," Ry",/,  &
...
!# 1295 "dynamics_module.f90"
      ...
      tau(:,:) = tau_new(:,:)
      !
!# 1390 "dynamics_module.f90"
      !
      CALL output_tau( .FALSE., .FALSE. )
      !
!# 1394 "dynamics_module.f90"
      !
      DEALLOCATE( step )
      !
   END SUBROUTINE proj_verlet
!# 1399 "dynamics_module.f90"
   SUBROUTINE fire( conv_ions )
!# 1401 "dynamics_module.f90"
     !------------------------------------------------------------------------
     !! This routine performs one step of structural relaxation using
...
!# 1615 "dynamics_module.f90"
     ...
     !
     !
!# 1694 "dynamics_module.f90"
     !
     CALL output_tau( .FALSE., .FALSE. )
     !
!# 1698 "dynamics_module.f90"
     !
     DEALLOCATE( step )
     !
   END SUBROUTINE fire 
...
!# 1845 "dynamics_module.f90"
      ...
      tau(:,:) = tau_new(:,:)
      !
!# 1862 "dynamics_module.f90"
      !
      CALL output_tau( .FALSE., .FALSE. )
      !
!# 1866 "dynamics_module.f90"
      !
