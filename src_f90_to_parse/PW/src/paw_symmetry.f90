...
!
    ...
    ENDIF
    !
!# 271 "paw_symmetry.f90"
    !
!# 291 "paw_symmetry.f90"
    !
...
!
    ...
    ENDIF
    !
!# 517 "paw_symmetry.f90"
    !
!# 537 "paw_symmetry.f90"
    !
    ! Apply symmetrization:
    ddd(:,:,:) = dddsym(:,:,:)
    !
...
!
    ...
    !
    !
!# 795 "paw_symmetry.f90"
    !
!# 817 "paw_symmetry.f90"
    !
    ! Apply symmetrization:
    dbecsum(:,:,:,:) = becsym(:,:,:,:)
    !
...
!#define __DEBUG_PAW_SYM
    ...
    !
    !
!# 1109 "paw_symmetry.f90"
    !
!# 1131 "paw_symmetry.f90"
    !
    ! Apply symmetrization:
    dbecsum(:,:,:,:) = becsym(:,:,:,:)
    !
...
!#define __DEBUG_PAW_SYM
    ...
    !
    !
!# 1300 "paw_symmetry.f90"
    !
!# 1322 "paw_symmetry.f90"
    !
    ! Apply symmetrization:
    dbecsum(:,:,:,:) = becsym(:,:,:,:)
    !
