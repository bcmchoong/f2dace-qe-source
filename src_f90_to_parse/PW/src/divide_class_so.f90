...
!
   ...
   DO iclass=2,nclass
      ...
      ENDIF
   ENDDO
!# 623 "divide_class_so.f90"
   CALL is_d2( iax, ibx, icx, ind2)
!# 625 "divide_class_so.f90"
...
sqr3d2=sqrt3*0.5d0
dsq2  =sqrt2*0.5d0
!# 1106 "divide_class_so.f90"
 char_mat=(1.d0,0.d0)
 char_mat(:,2)=(-1.d0,0.d0)
!# 1109 "divide_class_so.f90"
name_class1="     "
name_class(1)="E   "
name_class(2)="-E  "
!# 1114 "divide_class_so.f90"
IF (code_group==1) THEN
!
! C_1
!
   nclass_ref=2
   nrap_ref=1
!# 1121 "divide_class_so.f90"
   name_rap(1)="G_2  "
!# 1123 "divide_class_so.f90"
ELSEIF (code_group==2) THEN
!
! C_i
!
   nclass_ref=4
!# 1129 "divide_class_so.f90"
   name_class(3)="i    "
   name_class(4)="-i   "
!# 1132 "divide_class_so.f90"
   nrap_ref=2
!# 1134 "divide_class_so.f90"
   name_rap(1)="G_2+"
   char_mat(1,4)=(-1.d0,0.d0)
!# 1137 "divide_class_so.f90"
   name_rap(2)="G_2-"
   char_mat(2,3)=(-1.d0,0.d0)
!# 1140 "divide_class_so.f90"
...
!
   ...
   name_class(3)="s    "
   name_class(4)="-s   "
!# 1148 "divide_class_so.f90"
   nrap_ref=2
!# 1150 "divide_class_so.f90"
   name_rap(1)="G_3   "
   char_mat(1,3)=(0.d0, 1.d0)
   char_mat(1,4)=(0.d0,-1.d0)
!# 1154 "divide_class_so.f90"
   name_rap(2)="G_4   "
   char_mat(2,3)=(0.d0,-1.d0)
   char_mat(2,4)=(0.d0, 1.d0)
!# 1158 "divide_class_so.f90"
...
!
   ...
   name_class(3)="C2   "
   name_class(4)="-C2  "
!# 1166 "divide_class_so.f90"
   nrap_ref=2
!# 1168 "divide_class_so.f90"
   name_rap(1)="G_3   "
   char_mat(1,3)=(0.d0, 1.d0)
   char_mat(1,4)=(0.d0,-1.d0)
!# 1172 "divide_class_so.f90"
   name_rap(2)="G_4   "
   char_mat(2,3)=(0.d0,-1.d0)
   char_mat(2,4)=(0.d0, 1.d0)
!# 1177 "divide_class_so.f90"
ELSEIF (code_group==5) THEN
!
...
!
   ...
   name_class(5)="C3^2 "
   name_class(6)="-C3^2"
!# 1190 "divide_class_so.f90"
   nrap_ref=3
!# 1192 "divide_class_so.f90"
   name_rap(1)="G_4  "
...
!
   ...
   name_class(7)="C4^3 "
   name_class(8)="-C4^3"
!# 1228 "divide_class_so.f90"
   nrap_ref=4
!# 1230 "divide_class_so.f90"
   name_rap(1)="G_5  "
...
!
   ...
   name_class(11)="C6^5"
   name_class(12)="-C6^5"
!# 1290 "divide_class_so.f90"
   nrap_ref=6
!# 1292 "divide_class_so.f90"
   name_rap(1)="G_7  "
...
!
   ...
   name_class(5)="C2''"
   name_class1(5)="-C2''"
!# 1400 "divide_class_so.f90"
   nrap_ref=1
!# 1402 "divide_class_so.f90"
   name_rap(1)="G_5  "
...
!
   ...
   name_class(5)=" 3C2'"
   name_class(6)="-3C2'"
!# 1419 "divide_class_so.f90"
   nrap_ref=3
!# 1421 "divide_class_so.f90"
   name_rap(1)="G_4  "
   char_mat(1,1)=( 2.d0, 0.d0)
   char_mat(1,2)=(-2.d0, 0.d0)
   char_mat(1,4)=(-1.d0, 0.d0)
...
!# 1428 "divide_class_so.f90"
   name_rap(2)="G_5  "
   char_mat(2,2)=(-1.d0, 0.d0)
   char_mat(2,3)=(-1.d0, 0.d0)
   char_mat(2,5)=( 0.d0, 1.d0)
   char_mat(2,6)=( 0.d0,-1.d0)
!# 1434 "divide_class_so.f90"
   name_rap(3)="G_6  "
   char_mat(3,2)=(-1.d0, 0.d0)
   char_mat(3,3)=(-1.d0, 0.d0)
   char_mat(3,5)=( 0.d0,-1.d0)
   char_mat(3,6)=( 0.d0, 1.d0)
!# 1441 "divide_class_so.f90"
ELSEIF (code_group==10) THEN
!
! D_4
!
   ...
   name_class(7)="2C2'' "
   name_class1(7)="-2C2''"
!# 1455 "divide_class_so.f90"
   nrap_ref=2
!# 1457 "divide_class_so.f90"
   name_rap(1)="G_6  "
   char_mat(1,1)=( 2.d0, 0.d0)
   char_mat(1,2)=(-2.d0, 0.d0)
...
!
   ...
   name_class(5)=" s_v'"
   name_class1(5)="-s_v'"
!# 1488 "divide_class_so.f90"
   nrap_ref=1
!# 1490 "divide_class_so.f90"
   name_rap(1)="G_5  D_5"
   char_mat(1,1)=( 2.d0, 0.d0)
   char_mat(1,2)=(-2.d0, 0.d0)
   char_mat(1,3)=( 0.d0, 0.d0)
...
!
   ...
   name_class(5)="3s_v"
   name_class(6)="-3s_v"
!# 1507 "divide_class_so.f90"
   nrap_ref=3
!# 1509 "divide_class_so.f90"
   name_rap(1)="G_4   L_6 "
   char_mat(1,1)=( 2.d0, 0.d0)
   char_mat(1,2)=(-2.d0, 0.d0)
   char_mat(1,4)=(-1.d0, 0.d0)
   char_mat(1,5)=( 0.d0, 0.d0)
   char_mat(1,6)=( 0.d0, 0.d0)
!# 1516 "divide_class_so.f90"
   name_rap(2)="G_5   L_4 "
   char_mat(2,3)=(-1.d0, 0.d0)
   char_mat(2,5)=( 0.d0, 1.d0)
   char_mat(2,6)=( 0.d0,-1.d0)
!# 1521 "divide_class_so.f90"
   name_rap(3)="G_6   L_5 "
   char_mat(3,3)=(-1.d0, 0.d0)
   char_mat(3,5)=( 0.d0,-1.d0)
   char_mat(3,6)=( 0.d0, 1.d0)
!# 1526 "divide_class_so.f90"
ELSEIF (code_group==14) THEN
!
! C_4v
!
   ...
   name_class(7)=" 2s_d"
   name_class1(7)="-2s_d"
!# 1540 "divide_class_so.f90"
   nrap_ref=2
!# 1542 "divide_class_so.f90"
   name_rap(1)="G_6   D_6"
   char_mat(1,1)=( 2.d0, 0.d0)
   char_mat(1,2)=(-2.d0, 0.d0)
   char_mat(1,3)=CMPLX( sqrt2, 0.d0,kind=DP)
...
!
   ...
   ELSE
      ...
      name_class1(9)="-3C2''"
   END IF
!# 1583 "divide_class_so.f90"
   nrap_ref=3
!# 1585 "divide_class_so.f90"
   name_rap(1)="G_7  "
   char_mat(1,1)=( 2.d0, 0.d0)
   char_mat(1,2)=(-2.d0, 0.d0)
...
!
   ...
   name_class(7)="s_h "
   name_class(8)="-s_h"
!# 1628 "divide_class_so.f90"
   nrap_ref=4
!# 1630 "divide_class_so.f90"
   name_rap(1)="G_3+"
   char_mat(1,3)=( 0.d0, 1.d0)
   char_mat(1,4)=( 0.d0,-1.d0)
   char_mat(1,6)=(-1.d0, 0.d0)
...
!
   ...
   name_class(11)=" S3^5"
   name_class(12)="-S3^5"
!# 1678 "divide_class_so.f90"
   nrap_ref=6
!# 1680 "divide_class_so.f90"
   name_rap(1)="G_7  "
   char_mat(1,2)=(-1.d0, 0.d0)
   char_mat(1,3)=CMPLX( 0.5d0, sqr3d2,kind=DP)
   char_mat(1,4)=CMPLX(-0.5d0,-sqr3d2,kind=DP)
...
!
   ...
   name_class(15)="S4 "
   name_class(16)="-S4"
!# 1807 "divide_class_so.f90"
   nrap_ref=8
!# 1809 "divide_class_so.f90"
   name_rap(1)="G_5+ "
   char_mat(1,3)=CMPLX( dsq2, dsq2,kind=DP)
   char_mat(1,4)=CMPLX(-dsq2,-dsq2,kind=DP)
   char_mat(1,5)=( 0.d0, 1.d0)
...
!
   ...
   name_class(23)="S3 "
   name_class(24)="-S3 "
!# 1961 "divide_class_so.f90"
   nrap_ref=12
!# 1963 "divide_class_so.f90"
   name_rap(1)="G_7+ "
   char_mat(1,3)=CMPLX( sqr3d2, 0.5d0,kind=DP)
   char_mat(1,4)=CMPLX(-sqr3d2,-0.5d0,kind=DP)
   char_mat(1,5)=CMPLX( 0.5d0, sqr3d2,kind=DP)
...
!
   ...
   name_class(10)="s_v''"
   name_class1(10)="-s_v''"
!# 2336 "divide_class_so.f90"
   nrap_ref=2
!# 2338 "divide_class_so.f90"
   name_rap(1)="G_5+ "
   char_mat(1,1)=( 2.d0, 0.d0)
   char_mat(1,2)=(-2.d0, 0.d0)
   char_mat(1,3)=( 0.d0, 0.d0)
...
!
   ...
   name_class(9)=" 3s_v"
   name_class1(9)="-3s_v"
!# 2378 "divide_class_so.f90"
   nrap_ref=3
!# 2380 "divide_class_so.f90"
   name_rap(1)="G_7  "
   char_mat(1,1)=( 2.d0, 0.d0)
   char_mat(1,2)=(-2.d0, 0.d0)
   char_mat(1,4)=(-1.d0, 0.d0)
...
!
   ...
   name_class(14)=" 2s_d"
   name_class1(14)="-2s_d"
!# 2435 "divide_class_so.f90"
   nrap_ref=4
!# 2437 "divide_class_so.f90"
   name_rap(1)="G_6+  M_6+"
   char_mat(1,1)=( 2.d0, 0.d0)
   char_mat(1,2)=(-2.d0, 0.d0)
   char_mat(1,3)=CMPLX( sqrt2, 0.d0,kind=DP)
...
!
   ...
   name_class(18)=" 3s_d"
   name_class1(18)="-3s_d"
!# 2529 "divide_class_so.f90"
   nrap_ref=6
!# 2531 "divide_class_so.f90"
   name_rap(1)="G_7+ "
   char_mat(1,1)=( 2.d0, 0.d0)
   char_mat(1,2)=(-2.d0, 0.d0)
   char_mat(1,3)=CMPLX( sqrt3, 0.d0,kind=DP)
...
!
   ...
   name_class(7)="2s_d "
   name_class1(7)="-2s_d"
!# 2665 "divide_class_so.f90"
   nrap_ref=2
!# 2667 "divide_class_so.f90"
...
!
   ...
   name_class(11)="3s_v "
   name_class(12)="-3s_v"
!# 2701 "divide_class_so.f90"
   nrap_ref=6
!# 2703 "divide_class_so.f90"
   name_rap(1)="G_4+  L_6+"
   char_mat(1,1)=( 2.d0, 0.d0)
   char_mat(1,2)=(-2.d0, 0.d0)
   char_mat(1,4)=(-1.d0, 0.d0)
...
!
   ...
   name_class(7)=" S4 "
   name_class(8)="-S4 "
!# 2786 "divide_class_so.f90"
   nrap_ref=4
!# 2788 "divide_class_so.f90"
   name_rap(1)="G_5 "
   char_mat(1,3)=CMPLX( dsq2, dsq2,kind=DP)
   char_mat(1,4)=CMPLX(-dsq2,-dsq2,kind=DP)
   char_mat(1,5)=( 0.d0, 1.d0)
...
!
   ...
   name_class(11)="S6"
   name_class(12)="-S6"
!# 2848 "divide_class_so.f90"
   nrap_ref=6
!# 2850 "divide_class_so.f90"
   name_rap(1)="G_4+"
   char_mat(1,3)=CMPLX( 0.5d0, sqr3d2 ,kind=DP)
   char_mat(1,4)=CMPLX(-0.5d0,-sqr3d2 ,kind=DP)
!# 2854 "divide_class_so.f90"
!   char_mat(1,5)=CMPLX(-0.5d0, sqr3d2 ,kind=DP)
!   char_mat(1,6)=CMPLX( 0.5d0,-sqr3d2 ,kind=DP)
   char_mat(1,5)=CMPLX( 0.5d0,-sqr3d2 ,kind=DP)
   char_mat(1,6)=CMPLX(-0.5d0, sqr3d2 ,kind=DP)
!# 2859 "divide_class_so.f90"
...
!   char_mat(1,12)=CMPLX( 0.5d0,-sqr3d2 ,kind=DP)
   char_mat(1,11)=CMPLX( 0.5d0,-sqr3d2 ,kind=DP)
   char_mat(1,12)=CMPLX(-0.5d0, sqr3d2 ,kind=DP)
!# 2867 "divide_class_so.f90"
   name_rap(2)="G_5+"
   char_mat(2,3)=CMPLX( 0.5d0,-sqr3d2 ,kind=DP)
   char_mat(2,4)=CMPLX(-0.5d0, sqr3d2 ,kind=DP)
!# 2871 "divide_class_so.f90"
!   char_mat(2,5)=CMPLX(-0.5d0,-sqr3d2 ,kind=DP)
!   char_mat(2,6)=CMPLX( 0.5d0, sqr3d2 ,kind=DP)
   char_mat(2,5)=CMPLX( 0.5d0, sqr3d2 ,kind=DP)
   char_mat(2,6)=CMPLX(-0.5d0,-sqr3d2 ,kind=DP)
!# 2876 "divide_class_so.f90"
...
!
   ...
   name_class(6)=" 4C3'"
   name_class(7)="-4C3'"
!# 2951 "divide_class_so.f90"
   nrap_ref=3
!# 2953 "divide_class_so.f90"
   name_rap(1)="G_5 "
   char_mat(1,1)=( 2.d0, 0.d0)
   char_mat(1,2)=(-2.d0, 0.d0)
   char_mat(1,3)=( 0.d0, 0.d0)
...
!
   ...
   name_class(13)=" 4S6 "
   name_class(14)="-4S6 "
!# 3010 "divide_class_so.f90"
   nrap_ref=6
!# 3012 "divide_class_so.f90"
   name_rap(1)="G_5+"
   char_mat(1,1)=( 2.d0, 0.d0)
   char_mat(1,2)=(-2.d0, 0.d0)
   char_mat(1,3)=( 0.d0, 0.d0)
...
!
   ...
   name_class(8)="6s_d"
   name_class1(8)="-6s_d"
!# 3147 "divide_class_so.f90"
   nrap_ref=3
!# 3149 "divide_class_so.f90"
   name_rap(1)="G_6  P_6"
   char_mat(1,1)=( 2.d0, 0.d0)
   char_mat(1,2)=(-2.d0, 0.d0)
   char_mat(1,4)=(-1.d0, 0.d0)
...
!
   ...
   name_class(8)=" 6C2'"
   name_class1(8)="-6C2'"
!# 3191 "divide_class_so.f90"
   nrap_ref=3
!# 3193 "divide_class_so.f90"
   name_rap(1)="G_6  "
   char_mat(1,1)=(  2.d0, 0.d0)
   char_mat(1,2)=( -2.d0, 0.d0)
   char_mat(1,4)=( -1.d0, 0.d0)
...
!
   ...
   name_class(16)=" 6s_d"
   name_class1(16)="-6s_d"
!# 3245 "divide_class_so.f90"
   nrap_ref=6
!# 3247 "divide_class_so.f90"
   name_rap(1)="G_6+  "
   char_mat(1,1)=( 2.d0, 0.d0)
   char_mat(1,2)=(-2.d0, 0.d0)
   char_mat(1,4)=(-1.d0, 0.d0)
...
!# 3384 "divide_class_so.f90"
LOGICAL :: complex_aux(32)
!# 3386 "divide_class_so.f90"
...
INTEGER :: done
LOGICAL :: compare_mat_so
!# 3726 "divide_class_so.f90"
INTEGER :: i, j, k
!# 3728 "divide_class_so.f90"
DO i=1,nsym
   a1(:,:)=a(:,:,i)
   b1(:,:)=b(:,:,i)
   DO j=1,nsym
