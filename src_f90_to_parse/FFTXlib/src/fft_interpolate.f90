...
!# 26 "fft_interpolate.f90"
  call start_clock ('interpolate')
!# 28 "fft_interpolate.f90"
...
!# 48 "fft_interpolate.f90"
     ...
     ENDIF
!# 53 "fft_interpolate.f90"
     CALL invfft ('Rho', aux_out, dfft_out)
!# 55 "fft_interpolate.f90"
     v_out (1:dfft_out%nnr) = aux_out (1:dfft_out%nnr)
!# 57 "fft_interpolate.f90"
     DEALLOCATE (aux_in, aux_out)
!# 59 "fft_interpolate.f90"
  END IF
!# 61 "fft_interpolate.f90"
  call stop_clock ('interpolate')
!# 63 "fft_interpolate.f90"
  return
!# 65 "fft_interpolate.f90"
...
!# 88 "fft_interpolate.f90"
  IF (dfft_out%grid_id == dfft_in%grid_id) THEN
     ...
     !$acc end data
  ELSE
!# 96 "fft_interpolate.f90"
     ALLOCATE (aux_in( dfft_in%nnr))
     aux_in (1:dfft_in%nnr) = v_in(1:dfft_in%nnr)
!# 99 "fft_interpolate.f90"
     CALL fwfft ('Rho', aux_in, dfft_in)
!# 101 "fft_interpolate.f90"
     v_out(1:dfft_out%nnr) = (0.d0, 0.d0)
!# 103 "fft_interpolate.f90"
     ngm = min(dfft_in%ngm, dfft_out%ngm)
!# 105 "fft_interpolate.f90"
     v_out (dfft_out%nl (1:ngm) ) = aux_in (dfft_in%nl (1:ngm) )
!# 107 "fft_interpolate.f90"
     CALL invfft ('Rho', v_out, dfft_out)
!# 109 "fft_interpolate.f90"
     DEALLOCATE (aux_in)
!# 111 "fft_interpolate.f90"
  END IF
!# 113 "fft_interpolate.f90"
  call stop_clock ('interpolate')
!# 115 "fft_interpolate.f90"
  return
!# 117 "fft_interpolate.f90"
