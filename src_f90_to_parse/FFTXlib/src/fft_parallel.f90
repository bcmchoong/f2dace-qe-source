...
!$omp end parallel do
  ...
  RETURN
99 format ( 20 ('(',2f12.9,')') )
!# 157 "fft_parallel.f90"
  !
END SUBROUTINE tg_cft3s
!# 160 "fft_parallel.f90"
!
...
!# 202 "fft_parallel.f90"
  ...
  aux => dfft%aux
  !
!# 243 "fft_parallel.f90"
  call execute_using_threads()
!# 245 "fft_parallel.f90"
...
!# 844 "fft_parallel.f90"
  ii = i + dfft%nr1x * (j-1) + dfft%nr1x*dfft%nr2x * (k-1)
  f(ii) = f_in
!# 848 "fft_parallel.f90"
END SUBROUTINE put_f_of_R
!# 850 "fft_parallel.f90"
...
!# 897 "fft_parallel.f90"
  ii = i + dfft%nr1 * (j-1) + dfft%nr1*dfft%nr2 * (k-1)
  f(ii) = f_in
!# 900 "fft_parallel.f90"
END SUBROUTINE put_f_of_G
!# 902 "fft_parallel.f90"
