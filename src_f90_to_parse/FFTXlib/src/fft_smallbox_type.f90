...
!
!# 10 "fft_smallbox_type.f90"
MODULE fft_smallbox_type
!# 12 "fft_smallbox_type.f90"
  USE fft_types, ONLY: fft_type_descriptor
!# 14 "fft_smallbox_type.f90"
  IMPLICIT NONE
!# 16 "fft_smallbox_type.f90"
  SAVE
!# 18 "fft_smallbox_type.f90"
  INTEGER :: stdout = 6
!# 20 "fft_smallbox_type.f90"
...
!# 44 "fft_smallbox_type.f90"
  END TYPE
!# 46 "fft_smallbox_type.f90"
CONTAINS
!# 48 "fft_smallbox_type.f90"
!=----------------------------------------------------------------------------=!
!# 50 "fft_smallbox_type.f90"
...
!# 106 "fft_smallbox_type.f90"
    desc%irb( 1:3, 1:nat ) = irb( 1:3, 1:nat )
!# 108 "fft_smallbox_type.f90"
    DO isa = 1, nat
!# 110 "fft_smallbox_type.f90"
       imin3 = nr3b
       imax3 = 1
       irb3  = irb( 3, isa )
!# 114 "fft_smallbox_type.f90"
       DO ir3 = 1, nr3b
        ...
        &        CALL fftx_error__(' fft_box_set ',' ibig3 wrong ', ibig3 )
          ...
          ENDIF
       ENDDO
!# 125 "fft_smallbox_type.f90"
       desc%imin3( isa ) = imin3
       desc%imax3( isa ) = imax3
       desc%np3( isa )   = imax3 - imin3 + 1
!# 129 "fft_smallbox_type.f90"
       imin2 = nr2b
       imax2 = 1
       irb2  = irb( 2, isa )
!# 133 "fft_smallbox_type.f90"
       DO ir2 = 1, nr2b
