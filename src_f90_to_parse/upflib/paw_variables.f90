...
!# 18 "paw_variables.f90"
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    !!!! Pseudopotential data: !!!!
!# 21 "paw_variables.f90"
...
!# 24 "paw_variables.f90"
    ...
    LOGICAL  :: only_paw
!# 29 "paw_variables.f90"
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    !!!! Initialization data: !!!!
!# 32 "paw_variables.f90"
...
!# 58 "paw_variables.f90"
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    !!!! self-consistent variables: !!!!
!# 61 "paw_variables.f90"
