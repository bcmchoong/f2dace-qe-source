...
!# 173 "pseudo_types.f90"
  END TYPE pseudo_upf
!# 175 "pseudo_types.f90"
  TYPE pseudo_config
     INTEGER :: nwfs
...
!# 187 "pseudo_types.f90"
CONTAINS
!# 189 "pseudo_types.f90"
...
!# 332 "pseudo_types.f90"
  END SUBROUTINE reset_upf
!# 334 "pseudo_types.f90"
