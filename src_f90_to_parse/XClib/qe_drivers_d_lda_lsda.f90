...
!# 96 "qe_drivers_d_lda_lsda.f90"
     DO ir = 1, length
        ...
        !
     ENDDO
!# 116 "qe_drivers_d_lda_lsda.f90"
!$omp end do
!$omp end parallel
!# 119 "qe_drivers_d_lda_lsda.f90"
     !
  ELSE
     !
