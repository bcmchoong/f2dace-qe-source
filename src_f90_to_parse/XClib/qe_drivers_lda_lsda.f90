...
SUBROUTINE xc_lda( length, rho_in, ex_out, ec_out, vx_out, vc_out )
  ...
  !                      pi34 = (3/4pi)^(1/3)
!# 91 "qe_drivers_lda_lsda.f90"
  !
!# 96 "qe_drivers_lda_lsda.f90"
...
!# 103 "qe_drivers_lda_lsda.f90"
  DO ir = 1, length
     ...
     !
  ENDDO
!# 260 "qe_drivers_lda_lsda.f90"
!$omp end do
!$omp end parallel
!# 263 "qe_drivers_lda_lsda.f90"
  !
  RETURN
  !
...
SUBROUTINE xc_lsda( length, rho_in, zeta_in, ex_out, ec_out, vx_out, vc_out )
  ...
  !                      pi34 = (3/4pi)^(1/3)
  !
!# 318 "qe_drivers_lda_lsda.f90"
  !
!# 323 "qe_drivers_lda_lsda.f90"
!$omp parallel if(ntids==1) default(none) &
...
!# 331 "qe_drivers_lda_lsda.f90"
  DO ir = 1, length
     ...
     !
  ENDDO
!# 477 "qe_drivers_lda_lsda.f90"
!$omp end do
!$omp end parallel
!# 480 "qe_drivers_lda_lsda.f90"
  !
  RETURN
  !
