...
!# 908 "qe_funct_exch_gga.f90"
      phi=(lam+ny2)**(f12)
      psi=(eta+ny2)**(f12)
      xi=(zeta+ny2)**(f12)
!# 912 "qe_funct_exch_gga.f90"
      alpha=Two*ny*(xi-psi)
      dalphadn=dnydn*Two*(xi-psi+ny2/xi-ny2/psi)
      dalphads=dzetads*(ny/xi-ny/psi)
!# 916 "qe_funct_exch_gga.f90"
...
!# 2278 "qe_funct_exch_gga.f90"
      INTEGER :: i, nm1, k
      REAL(DP) :: a,b,c,d,del,fact,h,iarsum
!# 2281 "qe_funct_exch_gga.f90"
      ...
      ELSE
         ...
         do i=1,maxit
            ...
            IF (i /= nm1) THEN
               del = -fact/(i-nm1)
            ELSE
!# 2325 "qe_funct_exch_gga.f90"
               iarsum = 0.0d0
               do k=1,nm1
                  iarsum = iarsum + 1.0d0/k
               end do
!# 2330 "qe_funct_exch_gga.f90"
