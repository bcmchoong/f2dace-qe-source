...
!# 224 "mbd_vdw_param.f90"
contains
!# 226 "mbd_vdw_param.f90"
integer elemental function species_index(species)
    character(len=*), intent(in) :: species
!# 229 "mbd_vdw_param.f90"
    integer :: i
!# 231 "mbd_vdw_param.f90"
