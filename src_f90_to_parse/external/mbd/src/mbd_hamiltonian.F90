...
!# 17 "mbd_hamiltonian.F90"
implicit none
!# 19 "mbd_hamiltonian.F90"
private
public :: get_mbd_hamiltonian_energy
!# 22 "mbd_hamiltonian.F90"
...
!# 131 "mbd_hamiltonian.F90"
            call move_alloc(modes%val, res%modes)
!# 135 "mbd_hamiltonian.F90"
        end if
    else
...
!# 220 "mbd_hamiltonian.F90"
    call geom%clock(-15)
    call geom%clock(-22)
end function
!# 226 "mbd_hamiltonian.F90"
!# 1 "./mbd_hamiltonian.F90"
! This Source Code Form is subject to the terms of the Mozilla Public
! License, v. 2.0. If a copy of the MPL was not distributed with this
! file, You can obtain one at http://mozilla.org/MPL/2.0/.
!# 85 "./mbd_hamiltonian.F90"
...
!# 88 "./mbd_hamiltonian.F90"
    ...
    type(damping_t), intent(in) :: damp
    type(grad_request_t), intent(in) :: grad
!# 94 "./mbd_hamiltonian.F90"
    real(dp), intent(in) :: q(3)
!# 101 "./mbd_hamiltonian.F90"
...
!# 227 "mbd_hamiltonian.F90"
!# 228 "mbd_hamiltonian.F90"
end module
