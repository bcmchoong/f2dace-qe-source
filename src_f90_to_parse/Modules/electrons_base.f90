...
!------------------------------------------------------------------------------!
      ...
      USE kinds, ONLY: DP
!# 22 "electrons_base.f90"
!
      IMPLICIT NONE
      SAVE
!# 26 "electrons_base.f90"
      INTEGER :: nbnd       = 0
...
!# 83 "electrons_base.f90"
!
!------------------------------------------------------------------------------!
  CONTAINS
!------------------------------------------------------------------------------!
!# 89 "electrons_base.f90"
...
!# 104 "electrons_base.f90"
      REAL(DP)                     :: nelec, nelup, neldw, ocp, fsum
      INTEGER                      :: iss, i, in
!# 107 "electrons_base.f90"
      nspin = nspin_
      !
      ! ... set nelec
      !
...
!
    subroutine set_nelup_neldw ( tot_magnetization_, nelec_, nelup_, neldw_ )
      ...
      ELSE
         ...
         END IF
      END IF
!# 428 "electrons_base.f90"
      return
    end subroutine set_nelup_neldw
!# 431 "electrons_base.f90"
!----------------------------------------------------------------------------
!# 434 "electrons_base.f90"
...
!# 445 "electrons_base.f90"
!----------------------------------------------------------------------------
!# 447 "electrons_base.f90"
...
!# 476 "electrons_base.f90"
      ...
      DO iss = 1, nspin
         ...
         END DO
      END DO
!# 500 "electrons_base.f90"
      
      RETURN
!# 503 "electrons_base.f90"
    END SUBROUTINE distribute_bands
!# 506 "electrons_base.f90"
!------------------------------------------------------------------------------!
