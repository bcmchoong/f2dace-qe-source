...
!# 133 "print_chempot_vv.f90"
      WRITE(stdout, 1000) label1, label2, label3, usol_kcal
!# 135 "print_chempot_vv.f90"
      !
      label1 = '          '
      label2 = '          '
      label3 = 'GaussFluct'
...
!# 145 "print_chempot_vv.f90"
      WRITE(stdout, 1000) label1, label2, label3, usol_kcal
!# 147 "print_chempot_vv.f90"
      !
!# 151 "print_chempot_vv.f90"
1000  FORMAT(5X,A10,X,A10,X,A10,X,E14.6,' kcal/mol')
!# 153 "print_chempot_vv.f90"
      !
    END DO
  END DO
  !
