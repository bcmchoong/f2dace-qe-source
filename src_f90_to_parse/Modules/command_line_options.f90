...
!# 199 "command_line_options.f90"
     ...
     DO i=1,LEN_TRIM(input_command_line)
        ...
        previous = current
     END DO
!# 216 "command_line_options.f90"
  END SUBROUTINE my_getarg 
!# 218 "command_line_options.f90"
