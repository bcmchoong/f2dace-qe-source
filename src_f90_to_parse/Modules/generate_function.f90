...
!=----------------------------------------------------------------------=!
  ...
  USE kinds, ONLY: DP
!# 16 "generate_function.f90"
  IMPLICIT NONE
!# 18 "generate_function.f90"
CONTAINS
!----------------------------------------------------------------------
...
!----------------------------------------------------------------------
      ...
      INTEGER                   :: idx, narea
      !
!# 45 "generate_function.f90"
      ir_end = nnr
!# 47 "generate_function.f90"
      !
...
!----------------------------------------------------------------------
      ...
      !
!# 141 "generate_function.f90"
      ir_end = nnr
!# 143 "generate_function.f90"
      !
...
!----------------------------------------------------------------------
      ...
      inv_nr3 = 1.D0 / DBLE( dfftp%nr3 )
      !
!# 244 "generate_function.f90"
      ir_end = nnr
!# 246 "generate_function.f90"
      !
      IF (axis.LT.1.OR.axis.GT.3) &
           WRITE(stdout,*)'WARNING: wrong axis in generate_gaussian'
      IF ( dim .EQ. 0 ) THEN
...
!----------------------------------------------------------------------
      ...
      inv_nr3 = 1.D0 / DBLE( dfftp%nr3 )
      !
!# 346 "generate_function.f90"
      ir_end = nnr
!# 348 "generate_function.f90"
      !
      ALLOCATE( rholocal( nnr ) )
      rholocal = 0.D0
      !
...
!----------------------------------------------------------------------
      ...
      inv_nr3 = 1.D0 / DBLE( dfftp%nr3 )
      !
!# 429 "generate_function.f90"
      ir_end = nnr
!# 431 "generate_function.f90"
      !
      ALLOCATE( gradrholocal( 3, nnr ) )
      gradrholocal = 0.D0
      !
...
!----------------------------------------------------------------------
      ...
      inv_nr3 = 1.D0 / DBLE( dfftp%nr3 )
      !
!# 513 "generate_function.f90"
      ir_end = nnr
!# 515 "generate_function.f90"
      !
...
!----------------------------------------------------------------------
      ...
      inv_nr3 = 1.D0 / DBLE( dfftp%nr3 )
      !
!# 624 "generate_function.f90"
      ir_end = nnr
!# 626 "generate_function.f90"
      !
      ntot = dfftp%nr1 * dfftp%nr2 * dfftp%nr3
      !
      IF (axis.LT.1.OR.axis.GT.3) &
...
!----------------------------------------------------------------------
  ...
  inv_nr3 = 1.D0 / DBLE( dfftp%nr3 )
  !
!# 725 "generate_function.f90"
  ir_end = nnr
!# 727 "generate_function.f90"
  !
  DO ir = 1, ir_end
     !
     ! ... three dimensional indexes
...
!----------------------------------------------------------------------
  ...
  inv_nr3 = 1.D0 / DBLE( dfftp%nr3 )
  !
!# 787 "generate_function.f90"
  ir_end = nnr
!# 789 "generate_function.f90"
  !
  DO ir = 1, ir_end
     !
     ! ... three dimensional indexes
