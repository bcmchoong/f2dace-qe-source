...
!# 121 "input_parameters.f90"
        INTEGER :: nstep = 10
        !! number of simulation steps, see "restart_mode"
!# 124 "input_parameters.f90"
        INTEGER :: iprint = 10
...
!# 558 "input_parameters.f90"
        LOGICAL :: one_atom_occupations=.false.
!# 560 "input_parameters.f90"
...
!# 685 "input_parameters.f90"
        NAMELIST / system / ibrav, celldm, a, b, c, cosab, cosac, cosbc, nat, &
             ...
             nextffield
!# 721 "input_parameters.f90"
!=----------------------------------------------------------------------------=!
!  ELECTRONS Namelist Input Parameters
!=----------------------------------------------------------------------------=!
!# 725 "input_parameters.f90"
...
!# 1095 "input_parameters.f90"
!
!=----------------------------------------------------------------------------=!
!  IONS Namelist Input Parameters
!=----------------------------------------------------------------------------=!
!# 1101 "input_parameters.f90"
...
!# 1392 "input_parameters.f90"
!=----------------------------------------------------------------------------=!
!  WANNIER Namelist Input Parameters
!=----------------------------------------------------------------------------=!
!# 1396 "input_parameters.f90"
          LOGICAL :: wf_efield
          LOGICAL :: wf_switch
          !
          INTEGER :: sw_len
...
!  END manual
! ----------------------------------------------------------------------
!# 1449 "input_parameters.f90"
!=----------------------------------------------------------------------------=!
!  WANNIER_NEW Namelist Input Parameters
!=----------------------------------------------------------------------------=!
!# 1453 "input_parameters.f90"
...
!
      ...
      !! written to files 'KS.'
!# 1883 "input_parameters.f90"
!
!   PLOT_WANNIER
!
!# 1887 "input_parameters.f90"
      INTEGER, PARAMETER :: nwf_max = 1000
      !
      INTEGER :: wannier_index( nwf_max )
!# 1891 "input_parameters.f90"
!
!   WANNIER_NEW
!
      TYPE (wannier_data) :: wan_data(nwanx,2)
!# 1896 "input_parameters.f90"
!
!    SOLVENTS
!
...
!
      LOGICAL  :: tahub = .false.
!# 1914 "input_parameters.f90"
!  END manual
! ----------------------------------------------------------------------
!# 1917 "input_parameters.f90"
      LOGICAL :: xmloutput = .false.
      !! if TRUE PW produce an xml output
!# 1920 "input_parameters.f90"
CONTAINS
!
!----------------------------------------------------------------------------
