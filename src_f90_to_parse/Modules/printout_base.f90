...
!# 12 "printout_base.f90"
MODULE printout_base
!# 14 "printout_base.f90"
  USE kinds, only : DP
  IMPLICIT NONE
  SAVE
!# 18 "printout_base.f90"
  INTEGER, EXTERNAL :: find_free_unit
!# 20 "printout_base.f90"
CONTAINS
!# 23 "printout_base.f90"
FUNCTION printout_base_name( suffix )
   !  return the full name of a print out file with a given suffix
!# 26 "printout_base.f90"
...
!# 118 "printout_base.f90"
 
!# 120 "printout_base.f90"
