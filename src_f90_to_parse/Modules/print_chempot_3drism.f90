...
!# 150 "print_chempot_3drism.f90"
    WRITE(stdout, 300) label1, label2, usol_kcal
!# 152 "print_chempot_3drism.f90"
    !
    label1 = '          '
    label2 = 'GaussFluct'
...
!# 161 "print_chempot_3drism.f90"
    WRITE(stdout, 300) label1, label2, usol_kcal
!# 163 "print_chempot_3drism.f90"
    !
!# 167 "print_chempot_3drism.f90"
300 FORMAT(5X,A10,X,A10,X,E14.6,' kcal/mol')
!# 169 "print_chempot_3drism.f90"
    !
  END DO
  !
  WRITE(stdout, '()')
