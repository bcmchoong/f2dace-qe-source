...
!# 111 "clocks_handler.f90"
  ...
  DO n = 1, maxclock
     ...
     gputime(n)     = 0.0_DP
     clock_label(n) = ' '
!# 128 "clocks_handler.f90"
     !
  ENDDO
!# 145 "clocks_handler.f90"
  !
  RETURN
  !
